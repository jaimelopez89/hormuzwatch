...
function Metric({ label, value, color, detail, wide }) {
  return (
    ...
    >
      <div style={{ fontFamily: "monospace", fontSize: 8, letterSpacing: "0.15em", color: "#4a5568", textTransform: "uppercase" }}>
        {label}
      </div>
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-0.5">
          <div style={{ fontFamily: "monospace", fontSize: 9, letterSpacing: "0.2em", color: "#4a5568" }}>
            STRAIT OF HORMUZ
          </div>
          ...
          <div style={{ fontFamily: "monospace", fontSize: 10, color: "#4a5568" }}>
            ...
            {confidence === "LOW" && status && (
              <span style={{ color: "#1e3a5f" }}> · low confidence</span>
            )}
          </div>
        </div>
      </div>
      ...
      {/* Metric pills */}
      <div className="flex items-center gap-2 px-5 flex-1 min-w-0 overflow-x-auto">
        <Metric
        ...
        {pwPct != null ? (
          ...
          <Metric label="Transit Flow" value="…" color="#1e3a5f" detail="IMF PortWatch" />
        )}
        {polyPct != null && (
          <Metric
            label="Closure Risk"
